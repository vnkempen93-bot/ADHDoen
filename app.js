...
const EMOTION_BOXES = [
  { id: 'enthousiast', label: 'Enthousiast', x: 22.5, y: 12.7, w: 9.1, h: 4.0, yOffsetPx: 0.2 },
  { id: 'vrolijk', label: 'Vrolijk', x: 32.3, y: 12.7, w: 9.1, h: 4.0, yOffsetPx: 0.2 },
  { id: 'opgetogen', label: 'Opgetogen', x: 22.5, y: 21.5, w: 9.1, h: 4.0, yOffsetPx: 1 },
  { id: 'geamuseerd', label: 'Geamuseerd', x: 32.3, y: 21.5, w: 9.1, h: 4.0, yOffsetPx: 1 },
  { id: 'verwonderd', label: 'Verwonderd', x: 22.5, y: 30.4, w: 9.1, h: 4.0, yOffsetPx: 1.5 },
  { id: 'geinteresseerd', label: 'Geinteresseerd', x: 32.3, y: 30.4, w: 9.1, h: 4.0, yOffsetPx: 1.5 },
  { id: 'optimistisch', label: 'Optimistisch', x: 22.5, y: 39.2, w: 9.1, h: 4.0, yOffsetPx: 2.1 },
  { id: 'hoop', label: 'Hoop', x: 32.3, y: 39.2, w: 9.1, h: 4.0, yOffsetPx: 2.1 },
  ...
  { id: 'dankbaar', label: 'Dankbaar', x: 61.6, y: 12.7, w: 9.1, h: 4.0, yOffsetPx: 0.2 },
  { id: 'liefde', label: 'Liefde', x: 71.3, y: 12.7, w: 9.1, h: 4.0, yOffsetPx: 0.2 },
  { id: 'tevreden', label: 'Tevreden', x: 61.6, y: 21.5, w: 9.1, h: 4.0, yOffsetPx: 1 },
  { id: 'geborgen', label: 'Geborgen', x: 71.3, y: 21.5, w: 9.1, h: 4.0, yOffsetPx: 1 },
  { id: 'alert', label: 'Alert', x: 42.0, y: 30.4, w: 9.1, h: 16.8, yOffsetPx: 1.5 },
  { id: 'kalm', label: 'Kalm', x: 51.8, y: 30.4, w: 9.1, h: 16.8, yOffsetPx: 1.5 },
  { id: 'harmonie', label: 'Harmonie', x: 61.6, y: 30.4, w: 9.1, h: 4.0, yOffsetPx: 1.5 },
  { id: 'opgelucht', label: 'Opgelucht', x: 71.3, y: 30.4, w: 9.1, h: 4.0, yOffsetPx: 1.5 },
  { id: 'rust', label: 'Rust', x: 61.6, y: 39.2, w: 9.1, h: 4.0, yOffsetPx: 2.1 },
  { id: 'sereen', label: 'Sereen', x: 71.3, y: 39.2, w: 9.1, h: 4.0, yOffsetPx: 2.1 },
  { id: 'angst', label: 'Angst', x: 22.5, y: 48.1, w: 9.1, h: 4.0, yOffsetPx: 3 },
  { id: 'nerveus', label: 'Nerveus', x: 32.3, y: 48.1, w: 9.1, h: 4.0, yOffsetPx: 3},
  { id: 'gestrest', label: 'Gestrest', x: 22.5, y: 57.0, w: 9.1, h: 4.0, yOffsetPx: 3.5 },
  { id: 'onrust', label: 'Onrust', x: 32.3, y: 57.0, w: 9.1, h: 4.0, yOffsetPx: 3.5 },
  ...
  { id: 'vermoeid', label: 'Vermoeid', x: 61.6, y: 48.1, w: 9.1, h: 4.0, yOffsetPx: 3 },
  { id: 'uitgeput', label: 'Uitgeput', x: 71.3, y: 48.1, w: 9.1, h: 4.0, yOffsetPx: 3 },
  { id: 'futloos', label: 'Futloos', x: 61.6, y: 57.0, w: 9.1, h: 4.0, yOffsetPx: 3.5 },
  { id: 'lethargisch', label: 'Lethargisch', x: 71.3, y: 57.0, w: 9.1, h: 4.0, yOffsetPx: 3.5 },
  { id: 'boos', label: 'Boos', x: 22.5, y: 65.9, w: 9.1, h: 4.0, yOffsetPx: 4 },
  { id: 'beledigd', label: 'Beledigd', x: 32.3, y: 65.9, w: 9.1, h: 4.0, yOffsetPx: 4 },
  { id: 'afschuw', label: 'Afschuw', x: 22.5, y: 74.8, w: 9.1, h: 4.0, yOffsetPx: 4 },
  { id: 'minachting', label: 'Minachting', x: 32.3, y: 74.8, w: 9.1, h: 4.0, yOffsetPx: 4 },
  ...
  { id: 'schuldgevoel', label: 'Schuldgevoel', x: 61.6, y: 65.9, w: 9.1, h: 4.0, yOffsetPx: 4},
  { id: 'schaamte', label: 'Schaamte', x: 71.3, y: 65.9, w: 9.1, h: 4.0, yOffsetPx: 4 },
  { id: 'verdriet', label: 'Verdriet', x: 61.6, y: 74.8, w: 9.1, h: 4.0, yOffsetPx: 4 },
  { id: 'somber', label: 'Somber', x: 71.3, y: 74.8, w: 9.1, h: 4.0, yOffsetPx: 4 },
];

const EMOTION_BOX_TUNE = { x: 0.1, y: 0.15, w: -0.2, h: -0.2 };
...
function renderEmotionsOverlay() {
  ...
  emotionsOverlay.innerHTML = EMOTION_BOXES.map((box) => {
    ...
    const isLarge = box.h >= 12;
    const tunedH = isLarge ? 16.8 : 8.4;
    const actualHeight = isLarge ? '16.8%' : '8.4%';
    return `
      <button
        class="emoties-dot ${isSelected ? 'selected' : ''}"
        type="button"
        style="left:${tunedX}%; top:calc(${tunedY}% + ${yOffsetPx}px); width:${tunedW}%; height:${actualHeight}; min-height:0;"
